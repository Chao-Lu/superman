...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20160216"
...
class RestApi(object):
    ...
    def __init__(self, domain='http://gw.api.taobao.com', port = 80):
        #=======================================================================
        # 初始化基类
    ...
    async def getResponse(self, authrize=None, timeout=30):
        #=======================================================================
        # 获取response结果
        #=======================================================================
